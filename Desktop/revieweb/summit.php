...
$sql = "SELECT *   FROM ratings WHERE name_of_accom LIKE '% Summit %'";
...
$query = "SELECT ROUND(AVG(value),0) as averageRating FROM ratings WHERE name_of_accom LIKE '% Summit %'";
...
$query = "SELECT ROUND(AVG(reliability),0) as averageRating FROM ratings WHERE name_of_accom LIKE '% Summit %'";
$result = mysqli_query($conn,$query);
$fetchAverage = mysqli_fetch_array($result);
$averageRating = $fetchAverage['averageRating'];
...
$query2 = "SELECT ROUND(AVG(location),0) as averageRating2 FROM ratings WHERE name_of_accom LIKE '% Summit %'";
...
$query2 = "SELECT ROUND(AVG(quality),0) as averageRating2 FROM ratings WHERE name_of_accom LIKE '% Summit %'";
$result2 = mysqli_query($conn,$query);
$fetchAverage2 = mysqli_fetch_array($result2);
$averageRating2 = $fetchAverage2['averageRating'];
...
$query2 = "SELECT ROUND(AVG(internet),0) as averageRating2 FROM ratings WHERE name_of_accom LIKE '% Summit %'";
$result2 = mysqli_query($conn,$query);
$fetchAverage2 = mysqli_fetch_array($result2);
$averageRating2 = $fetchAverage2['averageRating'];
...
<div class="reviews">
  <div class="row blockquote review-item">
    ...
    <div class="addressdetails">
      <li><h6>Address:The Summit, Eastern Blvd ·  </h6></li>
      <li><h6>Phone Number: 0116 257 6303</h6></li>
