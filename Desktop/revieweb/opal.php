...
$sql = "SELECT *   FROM ratings WHERE name_of_accom LIKE '%Opal Court%'";
...
$query = "SELECT ROUND(AVG(value),0) as averageRating FROM ratings WHERE name_of_accom LIKE '%Opal Court%'";
...
$query = "SELECT ROUND(AVG(reliability),0) as averageRating FROM ratings WHERE name_of_accom LIKE '%Opal Court%'";
$result = mysqli_query($conn,$query);
$fetchAverage = mysqli_fetch_array($result);
$averageRating = $fetchAverage['averageRating'];
...
$query2 = "SELECT ROUND(AVG(location),0) as averageRating2 FROM ratings WHERE name_of_accom LIKE '%Opal Court%'";
...
$query2 = "SELECT ROUND(AVG(quality),0) as averageRating2 FROM ratings WHERE name_of_accom LIKE '%Opal Court%'";
$result2 = mysqli_query($conn,$query);
$fetchAverage2 = mysqli_fetch_array($result2);
$averageRating2 = $fetchAverage2['averageRating'];
...
$query2 = "SELECT ROUND(AVG(internet),0) as averageRating2 FROM ratings WHERE name_of_accom LIKE '%Opal Court%'";
$result2 = mysqli_query($conn,$query);
$fetchAverage2 = mysqli_fetch_array($result2);
$averageRating2 = $fetchAverage2['averageRating'];
           ...
           <div class="reviews">
             <div class="row blockquote review-item">
               ...
               <div class="addressdetails">
                 <li><h6>Address:60 Lancaster Rd, Leicester LE1 7HA </h6></li>
                 <li><h6>Phone Number: 0116 233 5678</h6></li>

               </div>
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2421.896348807743!2d-1.12979388422522!3d52.62571717983434!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x487761244f4d29c3%3A0xcf5d68afcc3c7503!2sOpal+Court%2C+60+Lancaster+Rd%2C+Leicester+LE1+7HA!5e0!3m2!1sen!2suk!4v1525123945958" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>           </div>
                 </div>
                 <div class="caption">
                   <small></small>
                 </div>
