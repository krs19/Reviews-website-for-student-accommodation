...
$sql = "SELECT *   FROM ratings WHERE name_of_accom LIKE '%Lumis%'";
...
$query = "SELECT ROUND(AVG(value),0) as averageRating FROM ratings WHERE name_of_accom LIKE '%Lumis%'";
...
$query = "SELECT ROUND(AVG(reliability),0) as averageRating FROM ratings WHERE name_of_accom LIKE '%Lumis%'";
$result = mysqli_query($conn,$query);
$fetchAverage = mysqli_fetch_array($result);
$averageRating = $fetchAverage['averageRating'];
...
$query2 = "SELECT ROUND(AVG(location),0) as averageRating2 FROM ratings WHERE name_of_accom LIKE '%Lumis%'";
...
$query2 = "SELECT ROUND(AVG(quality),0) as averageRating2 FROM ratings WHERE name_of_accom LIKE '%Lumis%'";
$result2 = mysqli_query($conn,$query);
$fetchAverage2 = mysqli_fetch_array($result2);
$averageRating2 = $fetchAverage2['averageRating'];
...
$query2 = "SELECT ROUND(AVG(internet),0) as averageRating2 FROM ratings WHERE name_of_accom LIKE '%Lumis%'";
$result2 = mysqli_query($conn,$query);
$fetchAverage2 = mysqli_fetch_array($result2);
$averageRating2 = $fetchAverage2['averageRating'];
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2421.4703595340975!2d-1.1400574842249742!3d52.63341467983578!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x487760dfd08e040f%3A0xbb0716700d1ba86e!2sLumis+Student+Living!5e0!3m2!1sen!2suk!4v1525104740698" width="700" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
              </div>
                    </div>
                    <div class="caption">
                      <small></small>
