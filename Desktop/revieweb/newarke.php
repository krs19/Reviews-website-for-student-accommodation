...
$sql = "SELECT *   FROM ratings WHERE name_of_accom LIKE '%Newarke Point%'";
...
$query = "SELECT ROUND(AVG(value),0) as averageRating FROM ratings WHERE name_of_accom LIKE '%Newarke Point%'";
...
$query = "SELECT ROUND(AVG(reliability),0) as averageRating FROM ratings WHERE name_of_accom LIKE '%Newarke Point%'";
$result = mysqli_query($conn,$query);
$fetchAverage = mysqli_fetch_array($result);
$averageRating = $fetchAverage['averageRating'];
...
$query2 = "SELECT ROUND(AVG(location),0) as averageRating2 FROM ratings WHERE name_of_accom LIKE '%Newarke Point%'";
...
$query2 = "SELECT ROUND(AVG(quality),0) as averageRating2 FROM ratings WHERE name_of_accom LIKE '%Newarke Point%'";
$result2 = mysqli_query($conn,$query);
$fetchAverage2 = mysqli_fetch_array($result2);
$averageRating2 = $fetchAverage2['averageRating'];
...
$query2 = "SELECT ROUND(AVG(internet),0) as averageRating2 FROM ratings WHERE name_of_accom LIKE '%Newarke Point%'";
$result2 = mysqli_query($conn,$query);
$fetchAverage2 = mysqli_fetch_array($result2);
$averageRating2 = $fetchAverage2['averageRating'];
...
<div class="reviews">
  <div class="row blockquote review-item">
    ...
    <div class="addressdetails">
      <li><h6>Address:Newarke Cl, Leicester LE2 7GY </h6></li>
      <li><h6>Phone Number: 0300 303 8649</h6></li>

    </div>
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2421.65426110319!2d-1.1442051342251238!3d52.63009172983512!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x487760de8144c395%3A0x8c37c05b2c7758db!2sNewarke+Point%2C+Newarke+Cl%2C+Leicester+LE2+7GY!5e0!3m2!1sen!2suk!4v1525100376118" width="800" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
