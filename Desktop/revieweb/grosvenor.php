...
$sql = "SELECT *   FROM ratings WHERE name_of_accom LIKE '%Grosvenor House%'";
...
$query = "SELECT ROUND(AVG(value),0) as averageRating FROM ratings WHERE name_of_accom LIKE '%Grosvenor House%'";
...
$query = "SELECT ROUND(AVG(reliability),0) as averageRating FROM ratings WHERE name_of_accom LIKE '%Grosvenor House%'";
$result = mysqli_query($conn,$query);
$fetchAverage = mysqli_fetch_array($result);
$averageRating = $fetchAverage['averageRating'];
...
$query2 = "SELECT ROUND(AVG(location),0) as averageRating2 FROM ratings WHERE name_of_accom LIKE '%Grosvenor House%'";
...
$query2 = "SELECT ROUND(AVG(quality),0) as averageRating2 FROM ratings WHERE name_of_accom LIKE '%Grosvenor House%'";
$result2 = mysqli_query($conn,$query);
$fetchAverage2 = mysqli_fetch_array($result2);
$averageRating2 = $fetchAverage2['averageRating'];
...
$query2 = "SELECT ROUND(AVG(internet),0) as averageRating2 FROM ratings WHERE name_of_accom LIKE '%Grosvenor House%'";
$result2 = mysqli_query($conn,$query);
$fetchAverage2 = mysqli_fetch_array($result2);
$averageRating2 = $fetchAverage2['averageRating'];
           ...
           <div class="reviews">
             <div class="row blockquote review-item">
               ...
               <div class="addressdetails">
                 <li><h6>Address:21-33 Newarke St, Leicester LE1 5SP </h6></li>
                 <li><h6>Phone Number: 020 3595 3265</h6></li>

               </div>
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2421.5472206939867!2d-1.1385180342250816!3d52.63202587983552!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x487760dff577aad3%3A0xb9121825ef17b500!2sGrosvenor+House%2C+Leicester!5e0!3m2!1sen!2suk!4v1525108360922" width="700" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
           </div>
                 </div>
                 <div class="caption">
                   <small></small>
