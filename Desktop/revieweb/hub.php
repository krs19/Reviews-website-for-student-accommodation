...
$sql = "SELECT *   FROM ratings WHERE name_of_accom LIKE '%Hub%'";
...
$query = "SELECT ROUND(AVG(value),0) as averageRating FROM ratings WHERE name_of_accom LIKE '%Hub%'";
...
$query = "SELECT ROUND(AVG(reliability),0) as averageRating FROM ratings WHERE name_of_accom LIKE '%Hub%'";
$result = mysqli_query($conn,$query);
$fetchAverage = mysqli_fetch_array($result);
$averageRating = $fetchAverage['averageRating'];
...
$query2 = "SELECT ROUND(AVG(location),0) as averageRating2 FROM ratings WHERE name_of_accom LIKE '%Hub%'";
...
$query2 = "SELECT ROUND(AVG(quality),0) as averageRating2 FROM ratings WHERE name_of_accom LIKE '%Hub%'";
$result2 = mysqli_query($conn,$query);
$fetchAverage2 = mysqli_fetch_array($result2);
$averageRating2 = $fetchAverage2['averageRating'];
...
$query2 = "SELECT ROUND(AVG(internet),0) as averageRating2 FROM ratings WHERE name_of_accom LIKE '%Hub%'";
$result2 = mysqli_query($conn,$query);
$fetchAverage2 = mysqli_fetch_array($result2);
$averageRating2 = $fetchAverage2['averageRating'];
           ...
           <div class="reviews">
             <div class="row blockquote review-item">
               ...
               <div class="addressdetails">
                 <li><h6>Address:The Hub 1 Burns Street Leicester LE2 6DJ </h6></li>
                 <li><h6>0844 288 99239</h6></li>

               </div>
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2422.702501345273!2d-1.131859884225832!3d52.611148079831516!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x487766d4a5c572b1%3A0x6db9029b71f93ffa!2s1+Burns+St%2C+Leicester+LE2+6DB!5e0!3m2!1sen!2suk!4v1525108487636" width="700" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
           </div>
                 </div>
                 <div class="caption">
                   <small></small>
